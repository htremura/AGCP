...
all: steering/main.c steering/steering.c steering/steering.h driving/main.c driving/driving.c driving/driving.h
	...
	avr-gcc -mmcu=atmega328p driving/driving.c driving/main.c -o driving/output/driving.elf
...
steering: steering/main.c steering/steering.c steering/steering.h
	avr-gcc -mmcu=atmega328p steering/steering.c steering/main.c -o steering/output/steering.elf
	avr-objcopy -h -S steering/output/steering.elf > steering/output/steering.lst
	avr-objcopy -j .text -j .data -O ihex steering/output/steering.elf steering/output/steering.hex
	avrdude -p m328p -c arduino -P /dev/ttyACM0 -D -U flash:w:steering/output/steering.hex:i

steering_make: steering/main.c steering/steering.c steering/steering.h
	avr-gcc -mmcu=atmega328p steering/steering.c steering/main.c -o steering/output/steering.elf
	avr-objcopy -h -S steering/output/steering.elf > steering/output/steering.lst
	avr-objcopy -j .text -j .data -O ihex steering/output/steering.elf steering/output/steering.hex
